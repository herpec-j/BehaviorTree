...
#include "BehaviorTree/Details/Private/IntegerConditionEnabler.hpp"
		...
		inline namespace Version_1
		{
			namespace Details
			{
				...
				public:
					...
					IntegerCondition(IntegerCondition &&) = default;

					// Assignment Operators
					IntegerCondition &operator=(IntegerCondition const &) = default;

					IntegerCondition &operator=(IntegerCondition &&) = default;
